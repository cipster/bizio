...
import { LedgerItemComponent } from 'app/entities/ledger-item/ledger-item.component';
...
describe('Component Tests', () => {
  describe('LedgerItem Management Component', () => {
    let comp: LedgerItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LedgerItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ledgerItems && comp.ledgerItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
