...
describe('Client e2e test', () => {
  ...
  it('should load Clients', async () => {
    ...
    expect(await clientComponentsPage.getTitle()).to.eq('bizioApp.client.home.title');
  ...
  it('should load create Client page', async () => {
    ...
    expect(await clientUpdatePage.getPageTitle()).to.eq('bizioApp.client.home.createOrEditLabel');
  ...
  it('should create and save Clients', async () => {
    ...
    await promise.all([clientUpdatePage.setNameInput('name')]);
  ...
  it('should delete last Client', async () => {
    ...
    expect(await clientDeleteDialog.getDialogTitle()).to.eq('bizioApp.client.delete.question');
