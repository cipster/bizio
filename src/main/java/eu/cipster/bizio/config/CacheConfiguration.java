package eu.cipster.bizio.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, eu.cipster.bizio.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, eu.cipster.bizio.repository.UserRepository.USERS_BY_EMAIL_CACHE);
